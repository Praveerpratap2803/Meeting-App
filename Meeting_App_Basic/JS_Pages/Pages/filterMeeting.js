...
(function(){
    ...
    function showSearchMeeting(meets){
        const meetingList = document.querySelector(".matchingMeets")
        console.log(meets)
        let meetingListStr=" "
        meets.forEach(
            function(meetings){
                ...
                meetingListStr += `
                    <div class="meetSep" meetID="${meetings._id}">
                        ...
                        <hr>
                        <div class="strAttendees" ><b>Attendees:</b> ${attendesStr} </div>
    ...
    function addingMember(){
        ...
        addFormContents.forEach(function(addFormContent){
            const selectMember = addFormContent.querySelector(".addMember")
            addFormContent.addEventListener("submit",function(event){
                event.preventDefault();
                const userID = selectMember.value;
                //console.log(userID);
                const meet = addFormContent.closest(".meetSep")
    ...
    function deleteMeeting(){
        ...
        buttons.forEach(function(button){
            button.addEventListener("click",function(){
                const deleteMeet = button.closest(".meetSep");//Returns the first (starting at element(button)) inclusive ancestor that matches selectors(here selector is .meetSep class , that ancestor have .meetSep class)
    ...
    function searchMeet(showADate,searchFor){
        ...
        .then(showSearchMeeting)
        
    }
    function addEventListeners(){
        searchForm=document.querySelector('#searchForm')
        searchDate=document.querySelector('#date')
        searchWord=document.querySelector('#description')
        searchForm.addEventListener('submit',function(event){
            ...
            searchMeet(showADate,searchFor);
